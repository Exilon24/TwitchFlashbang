...
namespace TwitchFlashbang
{
    ...
    public partial class App : Application
    {
        protected unsafe override void OnStartup(StartupEventArgs e)
        {
            ...
            nint result = (nint)User32.SetWindowLongPtr(windowHandle, User32.WindowLongIndexFlags.GWL_EXSTYLE, (void*)(currentStyles | WS_EX_COMPOSITED | WS_EX_TRANSPARENT | WS_EX_LAYERED));
